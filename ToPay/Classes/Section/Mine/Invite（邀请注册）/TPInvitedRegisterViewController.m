...
- (void)initWithUI {
    ...
    self.atly_tableViewTop.constant =[WRNavigationBar navBarBottom];
...
//    [self.tableView scrollToRowAtIndexPath:[NSIndexPath indexPathForRow:1 inSection:0] atScrollPosition:UITableViewScrollPositionBottom animated:YES];
    [self.tableView setContentOffset:CGPointMake(0, KHeight - self.customNavBar.height) animated:YES];
